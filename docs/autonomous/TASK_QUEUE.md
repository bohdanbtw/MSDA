...
App HEAD: **1.6.19** (T104 Hub pending-sales badge). Queue idle — suggest **T106** / **T142**.
...
|----------|----|--------|-------|------|
| — | — | idle | — | **Awaiting Boss.** Suggest **T106** / **T142**. |

### Acceptance (T104) — done 2026-08-21 (v1.6.19)
...
- **Post-1.6.19:** **T106/T142** → **T153+** / **T166+**; **T020** gated.
