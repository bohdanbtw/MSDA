...
- For Android login, prioritize Steam mobile-specific auth/session flow (SteamMobile/MobileSteamClient) over desktop-oriented login behavior, as they may differ.